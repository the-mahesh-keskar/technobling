...
// update query
$update_products =mysqli_query($conn, "update `products` 
set name ='$update_product_name',price ='$update_product_price',
...
{
    $display_message ="There is some Error in updating the products" ;
}
}
...
<body>
    ...
    if (isset($display_message)) {
        ...
        <i class = 'fas fa-times' onclick ='this.parentElement.style.dispaly =`none` ;></i> </div>" ;
    }
    ...
    if(isset($_GET['edit']))
     ...
     { $fetch_data =mysqli_fetch_assoc($edit_query);
      ...
      <form action="" method="post" enctype="multipart/form-data" class="update_product product_container_box">
            ...
            <div class="btns">
           <input type="Submit" class="edit_btn" value="Update Product" name="update product">
